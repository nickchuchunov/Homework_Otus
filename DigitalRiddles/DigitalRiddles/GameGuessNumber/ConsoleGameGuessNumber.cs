...
{
    public class ConsoleGameGuessNumber : IConsoleGameGuessNumber
    {
       public ConsoleGameGuessNumber() { }

       public ConsoleGame UserInterfaceStart()
        {
            ...
            return new ConsoleGame (UpperLimitNumber, LowerLimitNumber, NumberAttempts);
        }
